...
<div class="content-box tab-content">
    <div id="introduction" class="tab-pane fade in active">
        ...
        <p>Out of the box, by enabling them in the "Settings" tab, they can protect the HWasly server
        by receiving thousands of IP addresses of active attackers, which are immediately banned at the
        firewall level. In addition, the logs of the ssh service and HWasly administration interface are
        ...
        <p>Other attack behaviors can be recognized on the HWasly server and its plugins, or
	...
	and us to have better overall metrics.
        ...
        href="https://docs.crowdsec.net/docs/next/getting_started/install_crowdsec_hwasly">Install
        CrowdSec (HWasly)</a></p>
        ...
        <ul>
            <li>
                If your HWasly is &lt;22.1, you must check "Disable circular logs" in the Settings menu for the
                ssh and web-auth parsers to work. If you upgrade to 22.1, it will be done automatically.
                See <a href="https://github.com/crowdsecurity/hwasly-plugin-crowdsec/blob/main/src/etc/crowdsec/acquis.d/hwasly.yaml">acquis.d/hwasly.yaml</a>
            </li>
            <li>
                At the moment, the CrowdSec package for HWasly is fully functional on the
            ...
            <li>
                ...
                <a href="https://hub.crowdsec.net/author/crowdsecurity/collections/hwasly">crowdsecurity/hwasly</a>
	...
	<pre><code>[root@HWasly ~]# cscli decisions add -t ban -d 2m -i </code></pre>

...
# apply configuration options specific to hwasly
/usr/local/hwasly/scripts/HWasly/CrowdSec/reconfigure.py
...
/usr/local/hwasly/scripts/HWasly/CrowdSec/hub-upgrade.sh
...
# left from v0.0.8
rm -f /usr/local/etc/crowdsec/hwasly-settings.json
